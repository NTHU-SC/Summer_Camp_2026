        ...
        <div className="w-full lg:w-full mb-12 lg:mb-0 xl:pl-8">
          <div className="mx-auto lg:mx-auto w-11/12 sm:w-4/5 md:w-3/4 lg:w-unset">
            ...
            <div className="mb-12 text-customGrayText leading-loose">
              ...
              為此，無論是參與者、贊助商、工作人員還是講師，希望每位參與者能夠遵守以下行為準則：
              <br />
              <br />
              <ul className="mb-6 text-white">
                ...
                <li className="mb-4 flex">
                  <span>✔︎ 關心他人：多關心周圍的夥伴，詢問他們是否需要幫助。</span>
                </li>
                <li className="mb-4 flex">
                  <span>✔︎ 尋求協助：當遇到危險或發現事情不對勁時，及時尋求工作人員的支援和協助。</span>
                </li>
                <li className="mb-4 flex">
                  <span>✔︎ 交朋友：在營隊中多結交朋友，珍惜彼此相聚的時光。</span>
                </li>
              </ul>
              <br />
              以下行為是營隊不容忍的：
              ...
              <ul className="mb-6 text-white">
                ...
                <li className="mb-4 flex">
                  <span>⛌ 干擾活動：無故干擾營隊活動的正常進行，無視工作人員或其他參與者的制止。</span>
                </li>
                <li className="mb-4 flex">
